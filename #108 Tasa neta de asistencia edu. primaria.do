...
*6 A 11 AÑOS
gen     tna_pri=.
replace tna_pri=0 if codinfor!="00" & p204==1 & p203!= 8 & p203!= 9 & mes>= "04" & (p208a>=6 & p208a<=11)
replace tna_pri=1 if codinfor!="00" & p204==1 & p203!= 8 & p203!= 9 & mes>= "04" & (p208a>=6 & p208a<=11)& (p307==1 & inlist(p308a,2,7))
label value tna_pri tna


svyset [pweight = factora07], psu(conglome)strata(estrato)
svy: mean tna_pri 
svy: mean tna_pri , over(area)
svy: mean tna_pri , over(dpto)
