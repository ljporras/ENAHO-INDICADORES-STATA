...
*DE 3 A 5 AÑOS
gen     tna_ini=.
replace tna_ini=0 if codinfor!="00" & p204==1 & p203!= 8 & p203!= 9 & mes>= "04" & (p208a>=3 & p208a<=5)
replace tna_ini=1 if codinfor!="00" & p204==1 & p203!= 8 & p203!= 9 & mes>= "04" & (p208a>=3 & p208a<=5)& (p307==1 & p308a==1)
label value tna_ini tna


svyset [pweight = factora07], psu(conglome)strata(estrato)
svy: mean tna_ini 
svy: mean tna_ini , over(area)
svy: mean tna_ini , over(regnat)
